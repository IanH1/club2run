Router.configure({
    ...
    waitOn: function() {
        if (Meteor.user() && Meteor.user().profile && Meteor.user().profile.currentClubId) {
...
Router.route("/fixtures/squadselection/:_id", {
    name: "fixtureSquadSelection",
    title: "Squad Selection",
    parent: "eventList",
    data: function() {
        return SquadSelection.findOne(this.params._id);
    }
});
