...
TeamSelections.attachSchema(Schema.TeamSelection);

Schema.MatchNotification = new SimpleSchema({
    memberId: {
        type: String,
        regEx: SimpleSchema.RegEx.Id
    },
...
Schema.EventTraining = new SimpleSchema({
    team: {
        type: String,
        regEx: SimpleSchema.RegEx.Id,
        label: "Team"
