...
Article.attachSchema(Schema.ArticleSchema);
...
Club.attachSchema(Schema.ClubSchema);
...
Official.attachSchema(Schema.OfficialSchema);
...
Team.attachSchema(Schema.TeamSchema);
