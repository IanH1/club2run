...
Schema.Meeting = new SimpleSchema({
    ...
    'attendeeIds.$.availabilityComment': {
        type: String,
        label: "Comment",
        max: 100,
        optional: true
...
Schema.Article = new SimpleSchema({
    ...
    type: {
        type: String,
        allowedValues: ["MATCH_REPORT", "GENERAL"],
        max: 20
    },
    fixtureId: {
        type: String,
...
Schema.CalendarEvent = new SimpleSchema({
    type: {
        type: String,
        allowedValues: ["meeting", "fixture", "training"],
        optional: true
    },
    title: {
        type: String,
...
Schema.Notification = new SimpleSchema({
    type: {
        type: String,
        allowedValues: ["fixture", "training", "meeting"]
    },
    fixtureId: {
        type: String,
        regEx: SimpleSchema.RegEx.Id,
...
Schema.SquadSelection = new SimpleSchema({
    squad: {
        label: "Player(s)",
        type: Array,
        optional: true
...
SquadSelection.attachSchema(Schema.SquadSelection);
