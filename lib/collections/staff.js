...
Meteor.methods({
    insertStaff: function(staff) {
        ...
        // Add notification
        Meteor.call("insertNotification", {description: "Staff created by " + Meteor.user().profile.fullName});
    ...
    updateStaff: function(staff, modifier, staffId) {
        ...
        // Add notification
        Meteor.call("insertNotification", {description: "Staff updated by " + Meteor.user().profile.fullName});
    },
