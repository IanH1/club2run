...
if (Meteor.isServer) {
    Meteor.methods({
        ...
        insertFixture: function(fixture) {
            ...
            var messageBoardId = Meteor.call("createAndInsertMessageBoard", fixtureId, fixture.teamId)._id;
            ...
            var squadSelectionId = Meteor.call("createAndInsertSquadSelection", fixtureId, fixture.teamId)._id;
         ...
         * @param   fixtureId - the fixture id
         */
        updateFixtureResult: function(fixture, modifier, fixtureId) {
            ...
            Fixture.update(fixtureId, modifier);

            // Create a match report
            if (!fixture.articleId) {
                var articleId = Meteor.call("createAndInsertMatchReport", fixtureId)._id;

                // Update the fixture with the new article id
                Fixture.update(fixtureId, { $set: { reportId: articleId }});
            }
        }
    });
}