...
Meteor.methods({
    insertArticle: function(article) {
        ...
        if (!Meteor.user() || !Roles.userIsInRole(Meteor.user(), ['admin', 'club_admin','editor'], Roles.GLOBAL_GROUP)) {
...
Articles.allow({
    insert: function(userId) {
        return userId && Roles.userIsInRole(userId, ['admin', 'club_admin','editor'], Roles.GLOBAL_GROUP);
    },
